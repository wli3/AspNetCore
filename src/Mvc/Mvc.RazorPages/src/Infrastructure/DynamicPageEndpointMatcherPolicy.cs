...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure
{
    internal class DynamicPageEndpointMatcherPolicy : MatcherPolicy, IEndpointSelectorPolicy
    {
        ...
        public DynamicPageEndpointMatcherPolicy(DynamicPageEndpointSelector selector, IPageLoader loader)
        {
            if (selector == null)
            {
        ...
        public async Task ApplyAsync(HttpContext httpContext, EndpointSelectorContext context, CandidateSet candidates)
        {
            ...
            for (var i = 0; i < candidates.Count; i++)
            {
                ...
                var endpoints = await _selector.SelectEndpointsAsync(metadata.Values);
                ...
                var compiled = _loader.Load(endpoints[0].Metadata.GetMetadata<PageActionDescriptor>());
